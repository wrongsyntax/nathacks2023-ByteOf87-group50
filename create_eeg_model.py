...
data = pd.read_csv('EEG_data_2.csv')  # Replace 'your_dataset.csv' with the actual file name

# Step 2: Data Preprocessing
X = data.iloc[:, [0, 1, 2, 3]]  # Columns 2 to 12 are your features
#y = data['user-definedlabeln']  # Assuming the label is in the 'user-definedlabeln' column
y = data.iloc[:, 4]  # Assuming the label is in the 'user-definedlabeln' column
...
new_data = pd.read_csv('EEG_data_2.csv')  # Load new data
X_new = new_data.iloc[:, [0, 1, 2, 3]].values  # Extract relevant columns
